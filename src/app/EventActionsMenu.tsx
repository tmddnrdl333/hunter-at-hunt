...
/**
 * 카드 우측의 ⋮ 메뉴 — 캘린더 추가 / 링크 복사 (이후 항목 추가도 여기로).
...
export function EventActionsMenu({
  ...
  return (
    <span ref={wrapRef} className="relative">
      ...
      {open && (
        <span className="absolute right-0 top-full z-30 mt-1 w-56 overflow-hidden rounded-lg border border-stone-200 bg-white py-1 shadow-lg dark:border-stone-700 dark:bg-stone-900">
          <button
            onClick={(e) => {
              stop(e);
